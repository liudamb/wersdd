...
public class UpLoadimgController {
    ...
    String addProducts(@RequestParam String p_code, @RequestParam String p_name, @RequestParam String p_type, @RequestParam String brand, @RequestParam String p_num, @RequestParam String price, @RequestParam String intro, @RequestParam(value = "pic") MultipartFile multipartFile, HttpServletRequest request) throws IOException {
